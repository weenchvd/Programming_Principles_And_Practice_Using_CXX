...
void PolygonPPP2::draw_lines() const
{
    if (number_of_points() < 3) error("less than 3 points in a PolygonPPP2");
...
void RectanglePPP2::draw_lines() const
{
...
void EllipsePPP2::draw_lines() const
{
    if (color().visibility())
